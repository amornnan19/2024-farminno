...
@section('content')
    ...
    <div class="container-fluid main-content-sub-header text-center drop-shadow pb-3" style="overflow: hidden;">
                    ...
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            <a class="nav-link active" id="tab1-tab" data-toggle="tab" href="#tab1" role="tab"
                                aria-controls="tab1" aria-selected="true">ยี่ห้อทั้งหมด</a>
                        </div>
                        <div class="swiper-slide">
                            <a class="nav-link" id="tab2-tab" data-toggle="tab" href="#tab2" role="tab"
                                aria-controls="tab2" aria-selected="false">XAG</a>
                        </div>
                        <div class="swiper-slide">
                            <a class="nav-link" id="tab3-tab" data-toggle="tab" href="#tab3" role="tab"
                                aria-controls="tab3" aria-selected="false">DJI</a>
                        </div>
                        <div class="swiper-slide">
                            <a class="nav-link" id="tab1-tab" data-toggle="tab" href="#tab1" role="tab"
                                aria-controls="tab1" aria-selected="false">DJI</a>
                        </div>
                        <div class="swiper-slide">
                            <a class="nav-link" id="tab1-tab" data-toggle="tab" href="#tab1" role="tab"
                                aria-controls="tab1" aria-selected="false">DJI</a>
        ...
        {{-- <div class="tab-content" id="myTabContent">
            <div class="tab-pane fade show p-3 active" id="tab1" role="tabpanel" aria-labelledby="tab1-tab">
                Content for tab one
            </div>
            <div class="tab-pane fade show p-3" id="tab2" role="tabpanel" aria-labelledby="tab2-tab">
                Content for tab two
            </div>
            <div class="tab-pane fade show p-3" id="tab3" role="tabpanel" aria-labelledby="tab3-tab">
                            ...
                            <div class="dealer-home-content-box pt-2">
                                <div class="row mt-3 mb-3">
                                    ...
                                    <div class="col-8 p-0 status-text">
                                        ...
                                        การลงทะเบียนโดรน: <span class="status-warning-badge">อยู่ระหว่างดำเนินการ</span>
                                        <br>
                        ...
                        <a href="/service-status-detail">
                            <div class="dealer-home-content-box pt-2">
                                <div class="row mt-3 mb-3">
                                    <div class="col-4 p-0 pr-3 text-end status-label">
                                        <div class="img-box">
                                            <img src="{{ asset('img/dealer/3.png') }}" class="dealer-image"
                                                alt="">
                                        </div>
                                    </div>
                                    <div class="col-8 p-0 status-text">
                        ...
                        <a href="/service-status-detail">
                            <div class="dealer-home-content-box pt-2">
                                <div class="row mt-3 mb-3">
                                    <div class="col-4 p-0 pr-3 text-end status-label">
                                        <div class="img-box">
                                            <img src="{{ asset('img/dealer/1.png') }}" class="dealer-image"
                                                alt="">
                                        </div>
                                    </div>
                                    <div class="col-8 p-0 status-text">
                        ...
                        <a href="/service-status-detail">
                            <div class="dealer-home-content-box pt-2">
                                <div class="row mt-3 mb-3">
                                    <div class="col-4 p-0 pr-3 text-end status-label">
                                        <div class="img-box">
                                            <img src="{{ asset('img/dealer/2.png') }}" class="dealer-image"
                                                alt="">
                                        </div>
                                    </div>
                                    <div class="col-8 p-0 status-text">
