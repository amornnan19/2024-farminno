        ...
        <div class="d-block">
            ...
            <div class="form-group">
                ...
                <input type="text" name="" id="" class="form-control" placeholder=""
                    aria-describedby="" value="เปลี่ยนอะไหล่">
            </div>

            <h4 class="mb-0">แนบรูประหว่างซ่อม</h4>
            ...
            <div>
                <p class="form-title mb-0">ข้อมูลอะไหล่สำหรับซ่อม</p>
                <hr class="yellow-line">
            </div>

            <div class="form-group">
                <label for="">ซีเรียลนัมเบอร์เดิม</label>
                <input type="text" name="" id="" class="form-control" placeholder=""
                    aria-describedby="" value="">
            </div>

            <div class="form-group">
                <label for="">ชื่ออะไหล่เดิม</label>
                <input type="text" name="" id="" class="form-control" placeholder=""
                    aria-describedby="" value="เปลี่ยนอะไหล่">
            </div>

            <h4 class="mb-0">รูปภาพอะไหล่เดิม</h4>
            <div class="container mt-3 mb-3">
                <div>
            ...
            <div class="form-group">
                <label for="">ซีเรียลนัมเบอร์ใหม่</label>
                <input type="text" name="" id="" class="form-control" placeholder=""
                    aria-describedby="" value="">
            </div>

            <div class="form-group">
                <label for="">ชื่ออะไหล่ใหม่</label>
                <input type="text" name="" id="" class="form-control" placeholder=""
                    aria-describedby="" value="เปลี่ยนอะไหล่">
            </div>

            <h4 class="mb-0">รูปภาพอะไหล่ใหม่</h4>
            <div class="container mt-3 mb-3">
                <div>
            ...
            <div class="d-flex justify-content-center mt-3">
                <a onclick="success_modal()" class="btn primary-btn">บันทึก</a>
            </div>
...
@push('custom-script')
    ...
    <script>
        ...
        var options1 = {
            ...
            maxFilesize: 2, // MB
            addRemoveLinks: true,
            dictDefaultMessage: "<i class='fa-solid fa-plus'></i><br/>เลือกรูปภาพ",
            init: function() {
