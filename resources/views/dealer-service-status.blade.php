...
@push('custom-css')
    <style>
        ...
        .dealer-service-status-content-container {
            margin: 10px 0;
        ...
        .dealer-service-status-content-box pt-2 {
            margin: 10px 0;
        }

        .dealer-service-status-content-container .top-left-label-yellow {
            position: absolute;
            border: none;
            margin-left: 0px;
        ...
        .dealer-service-status-content-container .top-left-label-disabled {
            position: absolute;
            border: none;
            margin-left: 0px;
            padding: 2px 5px 2px 2px;
        ...
        .dealer-service-status-content-container a {
        ...
        .dealer-service-status-content-box .status-text {
            font-size: 14px;
            color: #1A1A1A;
        }

        .dealer-service-status-content-box .status-text span {
            color: #888888;
            font-weight: 600;
        }
...
@section('content')
    ...
    <div class="tab-content" id="myTabContent">
        <div class="tab-pane fade show active" id="tabOne" role="tabpanel" aria-labelledby="tabOne-tab">
            <div class="container-fluid service-status-content-container drop-shadow">
                <div class="container">
                    <a href="/dealer-service-product-detail">
                        <div class="service-status-content-box pt-2 pb-2">
                            <div class="row mt-3 mb-3">
                                <div class="col-5 text-end status-label">
                                    สถานะการซ่อม:
                                </div>
                                <div class="col-7 status-text ">
                                    <p class="text-center status-warning-badge">อยู่ระหว่างดำเนินการ</p>
                                </div>
                            </div>
                    ...
                    <a href="/dealer-service-product-detail">
                        <div class="service-status-content-box pt-2 pb-2">
                            <div class="row mt-3 mb-3">
                                ...
                                <div class="col-7 status-text ">
                                    <p class="text-center status-success-badge">ปิดงาน</p>
                                </div>
                            </div>
